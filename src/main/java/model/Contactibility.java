...
public class Contactibility {
    ...
    private Long contactibility_id;
    ...
    public Long getContactibility_id() {
        return contactibility_id;
    }

    public void setContactibility_id(Long contactibility_id) {
        this.contactibility_id = contactibility_id;
    }
